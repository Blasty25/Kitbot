...
public class MontyIOSim implements DrivetrainIOstart {
    ...
    {
        left_Motor.update(0.025);
        right_Motor.update(0.025);
        ...
        inputs.leftOutputVolts = left_Motor.getAngularVelocityRPM();
        inputs.leftVelocityMetersPerSecond = Units.radiansPerSecondToRotationsPerMinute(left_Motor.getAngularVelocityRPM() * MontyIntake.gearRatio) * Units.inchesToMeters(2);  
        ...
        inputs.rightOutputVolts = right_Motor.getAngularVelocityRPM();
    ...
    public void arcadeDrive(double left, double right) {
        left_Motor.setState(left_Motor.getAngularPositionRad(), left * Constants.DriveConstants.maxLeftSpeed);
        right_Motor.setState(right_Motor.getAngularPositionRad(),right * Constants.DriveConstants.maxRightSpeed);
    }
}